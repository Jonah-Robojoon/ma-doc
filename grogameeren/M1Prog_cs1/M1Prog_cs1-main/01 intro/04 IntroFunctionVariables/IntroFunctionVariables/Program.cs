...
namespace IntroChangeVariableValues
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            program.ShowIntroMessage("Welcome to my program",4);
        }

        private void ShowIntroMessage(
            string weewoo, //1) verzin hier een naam voor deze string variable
            int enterAmountToExit)
        {
            Console.WriteLine(weewoo);//gebruik hier je verzonnen naam van 1) 
